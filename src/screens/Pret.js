...
<View
  ...
  <View style={{flexDirection:'row',justifyContent:'center', alignItems:'center', padding:20}}>
               <View style={{backgroundColor:'#82EB06',marginRight:5, borderRadius:30, width:15,height:15}} />
               {/* <Image style={{width:10,height:10}} source={require('../assets/images/dot.png')} /> */}
               <Text style={{color:'#33333D', fontSize:15}}>Abonnement prêt</Text>
           </View>
 ...
 <View style={{justifyContent:'center',marginTop:10,backgroundColor:'white',width:Dimensions.get('window').width*0.7,height:50,shadowColor:'#1778BD',elevation:2,shadowOffset:{width:5,height:2},shadowOpacity:0.6,shadowRadius:15,borderRadius:3}}>
      <Text style={{margin:5,color:'#195581',fontSize:15}}>Carte MOKI</Text>
      </View>
     </View>
     <View style={{margin:15}}>
 ...
 <View style={{justifyContent:'center',marginTop:10,backgroundColor:'white',width:Dimensions.get('window').width*0.7,height:50,shadowColor:'#1778BD',elevation:2,shadowOffset:{width:5,height:2},shadowOpacity:0.6,shadowRadius:15,borderRadius:3}}>
      <Text style={{margin:5,color:'#195581',fontSize:15}}>dgbruno@gmail.com</Text>
      </View>
     </View>
...
<TouchableOpacity style={{backgroundColor:'#168F62',justifyContent:'center', margin:10,marginTop:20,marginBottom:50,height:70,resizeMode:'contain',borderRadius:8}}>
        <Text style={{fontSize:20,alignSelf:'center',color:'white',textAlign:'center'}}>Visualisez votre abonnement</Text>
       </TouchableOpacity>
       </ScrollView>
